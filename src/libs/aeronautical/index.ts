...
class Aeronautical {
  ...
  private listAlphabet(): Array<AeronauticAlphabet> {
    return [
      ...
      new AeronauticAlphabet("c", "charlie", ""),
      new AeronauticAlphabet("d", "delta", ""),
      new AeronauticAlphabet("e", "echo", ""),
      new AeronauticAlphabet("f", "foxtrot", ""),
      new AeronauticAlphabet("g", "golf", ""),
      new AeronauticAlphabet("h", "hotel", ""),
      new AeronauticAlphabet("i", "india", ""),
      new AeronauticAlphabet("j", "juliett", ""),
      new AeronauticAlphabet("k", "kilo", ""),
      new AeronauticAlphabet("l", "lima", ""),
      new AeronauticAlphabet("m", "mike", ""),
      new AeronauticAlphabet("n", "november", ""),
      new AeronauticAlphabet("o", "oscar", ""),
      new AeronauticAlphabet("p", "papa", ""),
      new AeronauticAlphabet("q", "quebec", ""),
      new AeronauticAlphabet("r", "romeo", ""),
      new AeronauticAlphabet("s", "sierra", ""),
      new AeronauticAlphabet("t", "tango", ""),
      new AeronauticAlphabet("u", "uniform", ""),
      new AeronauticAlphabet("v", "victor", ""),
      new AeronauticAlphabet("w", "whiskey", ""),
      new AeronauticAlphabet("x", "x-ray", ""),
      new AeronauticAlphabet("y", "yankee", ""),
      new AeronauticAlphabet("z", "zulu", ""),
    ];
  }
}
